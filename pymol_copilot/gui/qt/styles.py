...
# ==============================================================================
#
"""Stylesheet constants for UI blocks."""
...
"""
"""Stylesheet for splitter handles."""
...
"""
"""Stylesheet for the ribbon bar widget."""

RIBBON_PANEL_NAME_STYLE = "font-size: 8pt;"
"""Stylesheet for the ribbon panel name label."""

RIBBON_PANEL_SETTINGS_BUTTON_STYLE = """
QPushButton {
    background-color: white;
    border: none;
    padding: 0.15em;
...
QPushButton::hover {
    ...
    color: #4B91F7;
    border: 0.15em solid #DCDBE3;
    border: none;
}
"""
"""Stylesheet for the settings button in a ribbon panel."""
