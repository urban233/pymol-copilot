...
issues yourself. Never invoke another agent, delegate work, or switch to
`builder`, `reviewer`, or `orchestrator`, even if a workflow instruction
suggests delegation.
...
- Never invoke another agent or an external coding worker.
