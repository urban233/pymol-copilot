...
**Use Case:** Use when a developer needs help clarifying users, outcomes, scope, success measures, constraints, or assumptions. Does not design the technical solution or create implementation tasks -- those belong to `design-solution` and `plan-wave`.
...
**References:** This skill's own `SKILL.md`; `design-solution`; `plan-wave`.
